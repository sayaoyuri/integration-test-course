...
describe("GET /users tests", () => {
  it("should return a single user", async () => {
    const createdUser = await createUser("teste@gmail.com.br", "password123");
  ...
  it("should return all users", async () => {
    await createUser("teste@teste.com.br", "password123")
    await createUser("teste2@teste.com.br", "pass123")
